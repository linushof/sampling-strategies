...
* In contrast to the summary integration model, false response rates decrease with increasing switching probabilities.
...
cpt_roundwise_relative <- cpt_rondwise %>% filter(parameter == "alpha", threshold == "relative")
