...
plot(psi.store,choice.store.attract[1,],type = "p",ylim = c(0,1), xlab = expression(paste("Switching probability (", psi, ")")), ylab = "Proportion of choices of the safe option", pch=16, col= "green", main = "Summary comparison rule: Rare event attractive")
abline(h=.5,lty=2)
points(psi.store,choice.store.attract[2,], pch=17, col= "blue")
points(psi.store,choice.store.attract[3,], pch=19, col= "red")


plot(psi.store,choice.store.unattract[1,],type = "p",ylim = c(0,1), xlab = expression(paste("Switching probability (", psi, ")")), ylab = "Proportion of choices of the safe option", pch=16, col= "green", main = "Summary comparison rule: Rare event unattractive")
abline(h=.5,lty=2)
