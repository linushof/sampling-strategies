...
write_rds(postpred, "data/posterior_predictives.rds.bz2", compress = "bz2")
...
ggsave("manuscript/figures/appendix/ppc_summary_1.png", width = 14, height = 16)
...
ggsave("manuscript/figures/appendix/ppc_roundwise_1.png", width = 14, height = 16)
...
max_1_summary + pp_acc_summary + 
  ...
  plot_annotation(tag_levels = "A") & 
  theme(legend.position='top')
ggsave(file = "manuscript/figures/appendix/ppc_summary_2.png", width = 14, height = 10)
...
max_1_roundwise + pp_acc_roundwise + 
  ...
  plot_annotation(tag_levels = "A") & 
  theme(legend.position='top')
ggsave(file = "manuscript/figures/appendix/ppc_roundwise_2.png", width = 14, height = 10)
