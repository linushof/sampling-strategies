...
# set project path
here::i_am("supplements/data-analysis-report.Rmd")
...
For conceptual and methodological details, e.g., on sampling and integration strategies and there computational implementation, please refer to the <!--submitted -->manuscript<!--link document--> or the [source code](https://github.com/linushof/sampling-strategies/tree/main/code).
...
If you feel you have spotted an error/bug/etc. in the analyses---or any other part of this project---or in the case of any questions and remarks, please add an [issue](https://github.com/linushof/sampling-strategies/issues) to this repository or contact the author.
...
```{r trial-level n roundwise, fig.height=5}
...
```{r save trial-level n roundwise, eval=FALSE, include=FALSE}
ggsave(file = "supplements/data-analysis-report_files/figure-high-resolution/trial_n_roundwise.png", width = 14, height = 5)
```
...
```{r trial-level frequencies roundwise}
...
```{r save trial-level frequencies roundwise, eval=FALSE, include=FALSE}
ggsave(file = "supplements/data-analysis-report_files/figure-high-resolution/trial_ep_roundwise.png", width = 14, height = 12)
```
...
```{r round-level n, eval=FALSE, fig.height=5}
...
```{r save round-level n, eval=FALSE, include=FALSE}
ggsave(file = "supplements/data-analysis-report_files/figure-high-resolution/round_n_roundwise.png", width = 14, height = 5)
```

```{r insert figure round-level n, echo=FALSE}
knitr::include_graphics(path = here("supplements", "data-analysis-report_files", "figure-gfm", "round-level n-1.png"))
```
...
```{r round-level frequencies, eval=FALSE}
...
```{r save round-level frequencies, eval=FALSE, include=FALSE}
ggsave(file = "supplements/data-analysis-report_files/figure-high-resolution/round_n_roundwise.png", width = 14, height = 5)
```

```{r insert figure round-level frequencies, echo=FALSE}
knitr::include_graphics(path = here("supplements", "data-analysis-report_files", "figure-gfm", "round-level frequencies-1.png"))
```
...
```{r trial-level n summary, fig.height=5}
trial_n_median %>% 
...
```{r save trial-level n, eval=FALSE, include=FALSE}
ggsave(file = "supplements/data-analysis-report_files/figure-high-resolution/trial_n_summary.png", width = 14, height = 5)
```
...
```{r trial-level frequencies summary}
trial_ep_median %>% 
  filter(model == "summary") %>%
  ggplot(aes(p_r_high, y = median_ep_r_high, color = threshold)) + 
  facet_grid(psi~theta, 
...
```{r save trial_level frequencies, eval=FALSE, include=FALSE}
ggsave(file = "supplements/data-analysis-report_files/figure-high-resolution/trial_ep_summary.png", width = 14, height = 12)
```
...
```{r save choice rates roundwise, eval=FALSE, include=FALSE}
ggsave(file = "supplements/data-analysis-report_files/figure-high-resolution/choice_rates_roundwise.png", width = 14, height = 12)
```

```{r maximization rates roundwise}
...
rates %>%
  ...
  geom_line(aes(linetype = type, color = norm), size = 1) + 
  geom_point(aes(shape = threshold, color = norm), size = 4) +
  geom_line(data = rates_round_r, aes(linetype = type, color = norm), size = 1) + 
  geom_point(data = rates_round_r, aes(shape = threshold, color = norm), size = 4) +
  scale_color_scico_d(palette = "bam", begin = .2, end = .8) + 
  theme_apa()
```
...
```{r save choice rates summary, eval=FALSE, include=FALSE}
ggsave(file = "supplements/data-analysis-report_files/figure-high-resolution/choice_rates_roundwise.png", width = 14, height = 12)
```

```{r maximization rates summary}
...
rates %>%
  ...
  geom_line(aes(linetype = type, color = norm), size = 1) + 
  geom_point(aes(shape = threshold, color = norm), size = 4) +
  geom_line(data = rates_summary_r, aes(linetype = type, color = norm), size = 1) + 
  geom_point(data = rates_summary_r, aes(shape = threshold, color = norm), size = 4) +
  scale_color_scico_d(palette = "bam", begin = .2, end = .8) + 
  theme_apa()
```
...
```{r save weighting function roundwise, eval=FALSE, include=FALSE}
ggsave(file = "supplements/data-analysis-report_files/figure-high-resolution/weighting_function_roundwise.png", width = 14, height = 12)
```
...
```{r save value function roundwise, eval=FALSE, include=FALSE}
ggsave(file = "supplements/data-analysis-report_files/figure-high-resolution/value_function_roundwise.png", width = 14, height = 12)
```
...
```{r save weighting function summary, eval=FALSE, include=FALSE}
ggsave(file = "supplements/data-analysis-report_files/figure-high-resolution/weighting_function_summary.png", width = 14, height = 12)
```
...
```{r save value function summary, eval=FALSE, include=FALSE}
ggsave(file = "supplements/data-analysis-report_files/figure-high-resolution/value_function_summary.png", width = 14, height = 12)
```
