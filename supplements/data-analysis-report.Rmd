...
If you feel you spotted an error/bug/etc. in the analyses---or any other part of this project---or in the case of questions and remarks, please add an [issue](https://github.com/linushof/sampling-strategies/issues) to this repository or contact the author.
...
```{r insert figure round-level n, include=FALSE}
knitr::include_graphics(here("supplements", "data-analysis-report_files", "figure-high-resolution", "round_n_roundwise.png"))
```
...
```{r insert figure round-level frequencies, include=FALSE}
knitr::include_graphics(here("supplements", "data-analysis-report_files", "figure-high-resolution", "round_ep_roundwise.png"))
```
